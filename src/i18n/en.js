export const en = {
  ...
  find: {
    ...
    step3: {
      ...
      desc: "Set appointment date, service duration hours, and max hourly rate.",
      ...
      budgetLabel: "Max Hourly Rate (THB / hr)",
  ...
  caretaker: {
    ...
    verified: "Looklarn Standard Caregiver",
    ...
    verifiedTitle: "Safety & Quality Credentials",
    badgeBackground: "Police Criminal Records (Royal Thai Police)",
    badgeNurse: "Licensed Practical/Registered Nurse (Nursing Council)",
    badgeCaregiver: "Elderly Caregiver Standards (MOPH)",
    badgeCpr: "Emergency Lifesaving CPR Training (Thai Red Cross)",
    badgeIdVerified: "National ID Verification 100%",
    badgeDriver: "Senior Transport & Safe Driver Certified",
    stats: {
      experienceLabel: "Years in Service",
    ...
    bioTitle: "Caregiver Information",
    languagesTitle: "Languages Spoken",
    specialtiesTitle: "Caregiving Capabilities",
    ...
    reviewsTitle: "Feedback & Testimonials from Families",
    reviewsCount: "({count} Entries)",
