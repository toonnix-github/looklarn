export const th = {
  ...
  find: {
    ...
    step3: {
      ...
      desc: "กำหนดวันที่ ชั่วโมงที่ต้องการรับบริการ และอัตราค่าบริการที่เหมาะสม",
      ...
      budgetLabel: "อัตราค่าตอบแทนสูงสุดต่อชั่วโมง (บาท/ชม.)",
      budgetHint: "อัตราเฉลี่ย ฿300 - ฿500 ต่อชั่วโมง",
  ...
  caretaker: {
    ...
    verified: "ผู้ดูแลมาตรฐาน Looklarn",
    ...
    verifiedTitle: "เครื่องหมายความปลอดภัยและมาตรฐาน",
    badgeBackground: "ตรวจคดีอาชญากรรม กองทะเบียน (สตช.)",
    badgeNurse: "ใบอนุญาตประกอบวิชาชีพพยาบาล (สภาการพยาบาล)",
    badgeCaregiver: "มาตรฐานการดูแลผู้สูงอายุ (กระทรวงสาธารณสุข)",
    badgeCpr: "ทักษะช่วยชีวิตฉุกเฉิน CPR (สภากาชาดไทย)",
    badgeIdVerified: "ยืนยันตัวตนด้วยบัตรประชาชนและข้อมูลชีวมิติ 100%",
    badgeDriver: "ใบขับขี่และมาตรฐานขับขี่ปลอดภัย",
    stats: {
      experienceLabel: "อายุงานการดูแล",
      experienceValue: "{years} ปี",
      tripsLabel: "ดูแลสำเร็จ",
      tripsValue: "{count}+ ทริป",
      ratingLabel: "คะแนนพึงพอใจ",
      ratingValue: "{rating} / 5.0",
      responseLabel: "อัตราการตอบกลับ",
      responseValue: "100% (ภายใน 15 นาที)"
    },
    bioTitle: "ข้อมูลผู้ดูแล",
    languagesTitle: "ภาษาที่สื่อสารได้",
    specialtiesTitle: "ทักษะและความพร้อมในการดูแล",
    ...
    availabilityTitle: "ตารางเวลาที่ว่าง",
    calendar: {
    ...
    reviewsTitle: "ความคิดเห็นจากครอบครัวผู้ใช้บริการ",
